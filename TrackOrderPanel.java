...
public class TrackOrderPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        JPanel currentOrdersSection = new JPanel(new BorderLayout());
        currentOrdersSection.setBackground(BACKGROUND_COLOR);
        JLabel currentOrdersLabel = new JLabel(" ");
        currentOrdersLabel.setFont(new Font("Arial", Font.BOLD, 18));
        currentOrdersLabel.setForeground(TEXT_COLOR);
        currentOrdersSection.add(currentOrdersLabel, BorderLayout.NORTH);
        ...
        currentOrdersSection.add(currentOrdersScroll, BorderLayout.CENTER);

        mainContent.add(currentOrdersSection);
